...
function phraseFin(
    ...
    if (montantAAHAvecMVA <= 0 )
      ...
      phrase = (`Vous pouvez percevoir l'AAH à taux réduit pour un montant total de ${montantAAHAvecMVA.toFixed(2)} € par mois, soit ${Math.round(montantAAHAvecMVA -  (aah_amount))} € par mois par rapport au montant maximum de l'AAH.`)
